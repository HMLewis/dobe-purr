...
public class ChessboardTest {
	...
	@Test
	public void brandon() throws IllegalMoveException {
		Chessboard board = Algebraic.from("e4", "Na6", "Qf3", "Rb8", "Bc4", "b6", "Bxa6", "Ra8",  "Qd3");
		System.out.println(board);
		System.out.println(board.getLegalMoves());
		assertFalse(board.getLegalMoves().contains(new Move("BLACK_BISHOP_a6_d3xd3")));
	}
