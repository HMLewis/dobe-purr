...
public class ImageEditor extends Activity {
    public static final String LOG_TAG = ImageEditor.class.getName();
    private static final int ACTION_REQUEST_GALLERY = 99;
    private static final int ACTION_REQUEST_FEATHER = 100;
    private static final int EXTERNAL_STORAGE_UNAVAILABLE = 1;

    public final static int REQUEST_IMAGE_PICTURE = 1337;
    public final static int REQUEST_ENABLE_BT = 1338;
    /** Folder name on the sdcard where the images will be saved * */
    private static final String FOLDER_NAME = "emoji-pictures";
    Button mEditButton, mCameraButton, mShareButton, mEmojiButton;
    ImageView mImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmojiButton.setOnClickListener(
                new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Cannot Access Tables!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void onContentChanged() {
        ...
        mEmojiButton = (Button)findViewById(R.id.replaceButton);
    ...
    private void pickFromGallery() {
        ...
        startActivityForResult(galleryIntent, ACTION_REQUEST_GALLERY);
    }
    ...
    private void openCamera(){
        Intent capturePicture = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
        if (capturePicture.resolveActivity(getPackageManager()) != null) {
            startActivityForResult(capturePicture, REQUEST_IMAGE_PICTURE);
        }
    }
    ...
    class DownloadAsync extends AsyncTask<Uri, Void, Bitmap> implements
        ...
        protected void onPreExecute() {
            ...
            mProgress = new ProgressDialog(ImageEditor.this);
        ...
        protected Bitmap doInBackground(Uri... params) {
            ...
            bitmap = DecodeUtils.decode(
                ImageEditor.this, mUri, imageWidth,
                imageHeight, info);
            return bitmap;
        }
